...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ CommentAddBatchArray | [](imtmanagerapi_commentaddbatch.md "CommentAddBatch") [](imtmanagerapi_commentupdate.md "CommentUpdate") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::CommentAdd( IMTComment** comments, // array of documents const UINT comments_total, // number of documents in the array MTAPIRES* results // array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.CommentAdd( CIMTComment[] comments, // array of documents MTRetCode[] retcodes // array of results )  
---  
Parameters
comments
