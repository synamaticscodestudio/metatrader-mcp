...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNProviderArray ](imtecnproviderarray.md "IMTECNProviderArray")/ SearchLeft | [](imtecnproviderarray_searchless.md "SearchLess") [](imtecnproviderarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTECNProviderArray::SearchLeft
Search in an array the first element equal to the search key.
int IMTECNProviderArray::SearchLeft( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
