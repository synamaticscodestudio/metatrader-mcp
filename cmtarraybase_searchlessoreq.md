...
|  | [ Tools ](reference_tools.md "Tools") / [ CMTArrayBase ](cmtarraybase.md "CMTArrayBase")/ SearchLessOrEq | [](cmtarraybase_searchgreater.md "SearchGreater") [](cmtarraybase_searchless.md "SearchLess") |
| --- | --- | --- |
| --- | --- |

CMTArrayBase::SearchLessOrEq
Search in an array the first (from the end) element less than or equal to the search key.
static void* CMTArrayBase::SearchLessOrEq( const void *key, // Search key SMTSearch::SortFunctionPtr sort_function // Sort function )  
---  
Parameters
*key
