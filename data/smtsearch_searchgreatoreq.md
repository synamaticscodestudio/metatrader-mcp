...
|  | [ Tools ](reference_tools.md "Tools") / [ SMTSearch ](smtsearch.md "SMTSearch")/ SearchGreatOrEq | [](smtsearch_search.md "Search") [](smtsearch_searchgreater.md "SearchGreater") |
| --- | --- | --- |
| --- | --- |

SMTSearch::SearchGreatOrEq
Search in an array the first (from the array beginning) element greater than or equal to the search key.
static void* SMTSearch::SearchGreatOrEq( const void *key, // Search key void *base, // Array size_t total, // Number of elements const size_t width, // Element size SortFunctionPtr compare // A pointer to the search function )  
---  
Parameters
*key
