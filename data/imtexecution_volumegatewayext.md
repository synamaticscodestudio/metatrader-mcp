...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTExecution ](imtexecution.md "IMTExecution")/ VolumeGatewayExt | [](imtexecution_pricegateway.md "PriceGateway") [](imtexecution_actiongateway.md "ActionGateway") |
| --- | --- | --- |
| --- | --- |

IMTExecution::VolumeGatewayExt
Get the volume at which the deal is actually routed to an external trading system through the gateway.
C++
UINT64 IMTExecution::VolumeGatewayExt() const  
---  
.NET (Gateway/Manager API)
ulong CIMTExecution.VolumeGatewayExt()  
---  
Return Value
...
C++
MTAPIRES IMTExecution::VolumeGatewayExt( const UINT64 volume // deal volume )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTExecution.VolumeGatewayExt( ulong volume // deal volume )  
---  
Parameters
volume
