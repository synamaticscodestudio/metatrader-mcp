...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ .NET Implementation of Protocol ](net.md "Protocol Implementation in .NET") / [ MT5WebAPI Class ](net_mtwebapi.md "MT5WebAPI Class") / [ Prices ](net_tick.md "Prices")/ TickLast | [](net_tick.md "Prices") [](net_ticklastgroup.md "TickLastGroup") |
| --- | --- | --- |
| --- | --- |

MT5WebAPI.TickLast
Get the current prices of symbols.
MTRetCode MT5WebAPI.TickLast( string symbol, // Symbols out List<MTTick> ticks // An array of quotes )  
---  
Parameters
symbol
