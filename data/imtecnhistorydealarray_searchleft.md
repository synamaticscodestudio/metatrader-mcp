...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryDealArray ](imtecnhistorydealarray.md "IMTECNMatchingArray")/ SearchLeft | [](imtecnhistorydealarray_searchless.md "SearchLess") [](imtecnhistorydealarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryDealArray::SearchLeft
Search in an array the first element equal to the search key.
int IMTECNHistoryDealArray::SearchLeft( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
