...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTDocumentArray ](imtdocumentarray.md "IMTDocumentArray")/ SearchGreater | [](imtdocumentarray_searchgreatoreq.md "SearchGreatOrEq") [](imtdocumentarray_searchlessoreq.md "SearchLessOrEq") |
| --- | --- | --- |
| --- | --- |

IMTDocumentArray::SearchGreater
Search in an array for the first element greater than the search key.
int IMTDocumentArray::SearchGreater( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
