# FormatDateTimeMsc (MetaTrader5SDK)

|  | [ Tools ](reference_tools.md "Tools") / [ SMTFormat ](smtformat.md "SMTFormat")/ FormatDateTimeMsc | [](smtformat_formatdatetime.md "FormatDateTime") [](smtformat_formattime.md "FormatTime") |
| --- | --- | --- |
| --- | --- |
...
static LPCWSTR SMTFormat::FormatDateTimeMsc( CMTStr &str, // Reference to a string object const SYSTEMTIME &st, // Reference to SYSTEMTIME bool useTime=true, // Flag of hours and minutes bool useSec=false // Flag of seconds )  
---  
Program Parameters
&str
...
static LPCWSTR SMTFormat::FormatDateTimeMsc( CMTStr &str, // Reference to a string object INT64 ctm, // Date and Time bool useTime=true, // Flag of hours and minutes bool useSec=false // Flag of seconds )  
---  
Program Parameters
&str
[out] Reference to the [CMTStr](cmtstr.md "CMTStr") string object, into which information is placed.
