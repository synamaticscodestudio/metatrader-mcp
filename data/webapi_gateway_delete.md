...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Configuration Databases ](webapi_config.md "Configuration Databases") / [ Gateways ](webapi_gateway.md "Gateways")/ Delete | [](webapi_gateway_add.md "Add") [](webapi_gateway_shift.md "Shift") |
| --- | --- | --- |
| --- | --- |

Delete Gateway
The request allows deleting gateway configurations from the trading platform.
Request Format
GET /api/gateway/delete?index=indices GET /api/gateway/delete?name=names POST /api/gateway/delete?index=indices POST /api/gateway/delete?name=names  
---  
Response Format
{ "retcode" : "code description" }  
---  
Example
//--- request to the server GET /api/gateway/delete?index=0 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
