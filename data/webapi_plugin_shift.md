...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Configuration Databases ](webapi_config.md "Configuration Databases") / [ Plugins ](webapi_plugin.md "Plugins")/ Shift | [](webapi_plugin_delete.md "Delete") [](webapi_plugin_total.md "Get Total") |
| --- | --- | --- |
| --- | --- |
...
---  
Example
//--- request to the server GET /api/plugin/shift?index=0&shift=2 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
