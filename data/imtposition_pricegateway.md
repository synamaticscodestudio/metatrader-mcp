...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Positions ](trading_position.md "Positions") / [ IMTPosition ](imtposition.md "IMTPosition")/ PriceGateway | [](imtposition_reasonset.md "ReasonSet") [](imtposition_volumegatewayext.md "VolumeGatewayExt") |
| --- | --- | --- |
| --- | --- |

IMTPosition::PriceGateway
Get the price at which the position is actually opened through the gateway in the external trading system, excluding the [gateway price translation settings](imtcongateway_translateadd.md "TranslateAdd").
C++
double IMTPosition::PriceGateway() const  
---  
.NET (Gateway/Manager API)
double CIMTPosition.PriceGateway()  
---  
Return Value
The price at which the position is actually opened in the external system.
IMTPosition::PriceGateway
Set the price at which the position is actually opened through the gateway in the external trading system, excluding the [gateway price translation settings](imtcongateway_translateadd.md "TranslateAdd").
C++
MTAPIRES IMTPosition::PriceGateway( const double price // position price )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTPosition.PriceGateway( double price // position price )  
---  
Parameters
price
[in] The price at which the position is actually opened in the external system.
Return Value
