...
Request Format
GET /api/history_sync/shift?index=index&shift=shift POST /api/history_sync/shift?index=index&shift=shift  
---  
Response Format
{ "retcode" : "code description" }  
---  
Example
//--- request to the server GET /api/history_sync/shift?index=0&shift=2 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
