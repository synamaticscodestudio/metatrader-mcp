...
|  | [ Manager API ](managerapi.md "Manager API") / [ Administrator Interface ](imtadminapi.md "Administrator Interface") / [ Subscriptions ](imtadminapi_subscription.md "Subscriptions")/ SubscriptionUpdateBatch | [](imtadminapi_subscriptionupdate.md "SubscriptionUpdate") [](imtadminapi_subscriptionupdatebatcharray.md "SubscriptionUpdateBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTAdminAPI::SubscriptionUpdateBatch( IMTSubscriptionArray* records, // Array of subscriptions MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTAdminAPI.SubscriptionUpdateBatch( CIMTSubscriptionArray records, // Array of subscriptions MTRetCode[] res // Array of results )  
---  
Parameters
records
