...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNFilling ](imtecnfilling.md "IMTECNFilling")/ Symbol | [](imtecnfilling_state.md "State") [](imtecnfilling_type.md "Type") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTECNFilling::Symbol( LPCWSTR symbol // symbol )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTECNFilling.Symbol( string symbol // symbol )  
---  
Parameters
symbol
