...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Trade Activity ](imtmanagerapi_trade_operations.md "Trading Functions") / [ Monitoring Account States ](imtmanagerapi_trade_account.md "Account State Control")/ TradeAccountSet | [](imtmanagerapi_trade_account.md "Account State Control") [](imtmanagerapi_book.md "Depth of Market Functions") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::TradeAccountSet( const INT64 request_id, // Request ID const IMTUser* user, // An object of a client record const IMTAccount* account, // An object of a trading account const IMTOrderArray* orders, // Orders array const IMTPositionArray* positions // Positions array )  
---  
.NET
MTRetCode CIMTManagerAPI.TradeAccountSet( long request_id, // Request ID CIMTUser user, // An object of a client record CIMTAccount account, // An object of a trading account CIMTOrderArray orders, // Orders array CIMTPositionArray positions // Positions array )  
---  
Python
ManagerAPI.TradeAccountSet( request_id, # Request ID user, # An object of a client record account, # An object of a trading account orders, # Orders array positions # Positions array )  
---  
Parameters
request_id
[in] Arbitrary request ID. It is used for binding the requests executed by this method and the answers received via [IMTManagerSink::OnTradeAccountSet](imtmanagersink_ontradeaccountset.md "OnTradeAccountSet").
user
...
positions
[in] [An object of the array of positions](imtpositionarray.md "IMTPositionArray") placed for the specified account. To avoid position synchronization, pass the NULL value.
Return Value
...
Execution result, as well as the final status of a client entry are passed to [IMTManagerSink::OnTradeAccountSet](imtmanagersink_ontradeaccountset.md "OnTradeAccountSet") handler.
