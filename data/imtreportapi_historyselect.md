# HistorySelect (MetaTrader5SDK)

|  | [ Report API ](reportapi.md "Report API") / [ Main Interface of Reports ](imtreportapi.md "Main Report Interface") / [ Trade Databases ](imtreportapi_trade.md "Trade Database Functions") / [ Orders ](imtreportapi_order.md "Orders")/ HistorySelect | [](imtreportapi_historyget.md "HistoryGet") [](imtreportapi_deal.md "Deals") |
| --- | --- | --- |
| --- | --- |

IMTReportAPI::HistorySelect
Request closed orders from a database according to specified criteria.
MTAPIRES IMTReportAPI::HistorySelect( const IMTDatasetRequest* request, // Request description IMTDataset* dataset // Data set )  
---  
Parameters
request
