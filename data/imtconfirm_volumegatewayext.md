...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTConfirm ](imtconfirm.md "IMTConfirm")/ VolumeGatewayExt | [](imtconfirm_pricegateway.md "PriceGateway") [](imtconfirm_actiongateway.md "ActionGateway") |
| --- | --- | --- |
| --- | --- |

IMTConfirm::VolumeGatewayExt
Get the volume at which the deal is actually routed to an external trading system through the gateway.
C++
UINT64 IMTConfirm::VolumeGatewayExt() const  
---  
.NET (Gateway/Manager API)
ulong CIMTConfirm.VolumeGatewayExt()  
---  
Return Value
...
C++
MTAPIRES IMTConfirm::VolumeGatewayExt( const UINT64 volume // deal volume )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTConfirm.VolumeGatewayExt( ulong volume // deal volume )  
---  
Parameters
volume
