...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Deals ](trading_deal.md "Deals") / [ IMTDeal ](imtdeal.md "IMTDeal")/ PriceGateway | [](imtdeal_gatewayset.md "GatewaySet") [](imtdeal_pricegatewayset.md "PriceGatewaySet") |
| --- | --- | --- |
| --- | --- |

IMTDeal::PriceGateway
Gets the actual price of a deal executed via a gateway in an external trading system, not taking into account the [gateway price transformation settings](imtcongateway_translateadd.md "TranslateAdd").
C++
