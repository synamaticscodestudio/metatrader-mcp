...
|  | [ Configuration Interfaces ](reference_configurations.md "Configuration Interfaces") / [ Groups ](config_group.md "Groups") / [ IMTConGroupArray ](imtcongrouparray.md "IMTConGroupArray")/ SearchLeft | [](imtcongrouparray_searchless.md "SearchLess") [](imtcongrouparray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTConGroupArray::SearchLeft
Search an array for the first element equal to the search key.
int IMTConGroupArray::SearchLeft( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to search function ) const  
---  
Parameters
*key
