...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNProviderArray ](imtecnproviderarray.md "IMTECNProviderArray")/ SearchRight | [](imtecnproviderarray_searchleft.md "SearchLeft") [](imtecnhistorymatching.md "IMTECNMatching") |
| --- | --- | --- |
| --- | --- |

IMTECNProviderArray::SearchRight
Search in an array the last element equal to the search key.
int IMTECNProviderArray::SearchRight( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
