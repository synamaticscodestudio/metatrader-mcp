...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNMatchingArray ](imtecnmatchingarray.md "IMTECNMatchingArray")/ SearchLess | [](imtecnmatchingarray_searchlessoreq.md "SearchLessOrEq") [](imtecnmatchingarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTECNMatchingArray::SearchLess
Search in an array the first element less than the search key.
int IMTECNMatchingArray::SearchLess( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
