...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Configuration Databases ](webapi_config.md "Configuration Databases") / [ Reports ](webapi_report.md "Reports")/ Shift | [](webapi_report_delete.md "Delete") [](webapi_report_total.md "Get Total") |
| --- | --- | --- |
| --- | --- |
...
---  
Example
//--- request to the server GET /api/report/shift?index=0&shift=2 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
