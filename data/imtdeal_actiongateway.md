...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Deals ](trading_deal.md "Deals") / [ IMTDeal ](imtdeal.md "IMTDeal")/ ActionGateway | [](imtdeal_volumegatewayext.md "VolumeGatewayExt") [](imtdeal_marketbid.md "MarketBid") |
| --- | --- | --- |
| --- | --- |

IMTDeal::ActionGateway
Get the direction with which the deal is actually routed to an external trading system through the gateway.
C++
UINT IMTDeal::ActionGateway() const  
---  
.NET (Gateway/Manager API)
uint CIMTDeal.ActionGateway()  
---  
Return Value
...
C++
MTAPIRES IMTDeal::ActionGateway( const UINT action // direction )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTDeal.ActionGateway( uint action // direction )  
---  
Parameters
action
