...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryFillingArray ](imtecnhistoryfillingarray.md "IMTECNFillingArray")/ SearchGreater | [](imtecnhistoryfillingarray_searchgreatoreq.md "SearchGreatOrEq") [](imtecnhistoryfillingarray_searchlessoreq.md "SearchLessOrEq") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryFillingArray::SearchGreater
Search in an array for the first element greater than the search key.
int IMTECNHistoryFillingArray::SearchGreater( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
