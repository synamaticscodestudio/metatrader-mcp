...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTDocumentArray ](imtdocumentarray.md "IMTDocumentArray")/ SearchLess | [](imtdocumentarray_searchlessoreq.md "SearchLessOrEq") [](imtdocumentarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTDocumentArray::SearchLess
Search in an array for the first element less than the search key.
int IMTDocumentArray::SearchLess( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
