...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Configuration Databases ](serverapi_configuration.md "Configuration databases") / [ Firewall ](serverapi_config_firewall.md "Firewall")/ FirewallDelete | [](imtserverapi_firewalladd.md "FirewallAdd") [](imtserverapi_firewallshift.md "FirewallShift") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::FirewallDelete
Delete a firewall configuration by the index.
MTAPIRES IMTServerAPI::FirewallDelete( const UINT pos // Position of the configuration )  
---  
Parameters
pos
