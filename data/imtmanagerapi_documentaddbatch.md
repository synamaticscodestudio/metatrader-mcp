...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ DocumentAddBatch | [](imtmanagerapi_documentadd.md "DocumentAdd") [](imtmanagerapi_documentaddbatcharray.md "DocumentAddBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::DocumentAddBatch( IMTDocumentArray* documents, // array of documents MTAPIRES* results // array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.DocumentAddBatch( CIMTDocumentArray documents, // array of documents MTRetCode[] retcodes // array of results )  
---  
Parameters
documents
