...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryFilling ](imtecnhistoryfilling.md "IMTECNFilling")/ Provider | [](imtecnhistoryfilling_deviation.md "Deviation") [](imtecnhistoryfilling_comment.md "Comment") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTECNHistoryFilling::Provider( const UINT64 provider_id // provider )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTECNHistoryFilling.Provider( ulong provider_id // provider )  
---  
Parameters
provider_id
