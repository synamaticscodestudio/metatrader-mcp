...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Positions ](trading_position.md "Positions") / [ IMTPositionArray ](imtpositionarray.md "IMTPositionArray")/ SearchRight | [](imtpositionarray_searchleft.md "SearchLeft") [](imtpositionsink.md "IMTPositionSink") |
| --- | --- | --- |
| --- | --- |

IMTPositionArray::SearchRight
Search in an array the last element equal to the search key.
int IMTPositionArray::SearchRight( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
