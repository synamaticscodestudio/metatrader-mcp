...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryMatchingArray ](imtecnhistorymatchingarray.md "IMTECNMatchingArray")/ SearchLess | [](imtecnhistorymatchingarray_searchlessoreq.md "SearchLessOrEq") [](imtecnhistorymatchingarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryMatchingArray::SearchLess
Search in an array the first element less than the search key.
int IMTECNHistoryMatchingArray::SearchLess( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
