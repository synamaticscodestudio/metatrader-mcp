...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Assets ](trading_exposure.md "Assets") / [ IMTExposureArray ](imtexposurearray.md "IMTExposureArray")/ SearchLessOrEq | [](imtexposurearray_searchgreater.md "SearchGreater") [](imtexposurearray_searchless.md "SearchLess") |
| --- | --- | --- |
| --- | --- |

IMTExposureArray::SearchLessOrEq
Search in an array the first element less than or equal to the search key.
int IMTExposureArray::SearchLessOrEq( const void *key, // Sort key MTSortFunctionPtr sort_function // Sort function ) const  
---  
Parameters
*key
