...
|  | [ Manager API ](managerapi.md "Manager API") / [ Administrator Interface ](imtadminapi.md "Administrator Interface") / [ Clients ](imtadminapi_clients.md "Clients")/ ClientAddBatchArray | [](imtadminapi_clientaddarray.md "ClientAddBatch") [](imtadminapi_clientupdate.md "ClientUpdate") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTAdminAPI::ClientAddBatchArray( IMTClient** clients, // array of clients const UINT clients_total, // number of clients in the array MTAPIRES* results // array of results )  
---  
.NET
MTRetCode CIMTAdminAPI.ClientAddBatchArray( IMTClient[] clients, // array of clients MTRetCode[] retcodes // array of results )  
---  
Parameters
clients
