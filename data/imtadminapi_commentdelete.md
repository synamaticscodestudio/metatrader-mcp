...
|  | [ Manager API ](managerapi.md "Manager API") / [ Administrator Interface ](imtadminapi.md "Administrator Interface") / [ Clients ](imtadminapi_clients.md "Clients")/ CommentDelete | [](imtadminapi_commentupdatebatcharray.md "CommentUpdateBatchArray") [](imtadminapi_commentdeletebatch.md "CommentDeleteBatch") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTAdminAPI::CommentDelete( IMTComment* comment // comment object )  
---  
.NET
MTRetCode CIMTAdminAPI.CommentDelete( CIMTComment comment // comment object )  
---  
Parameters
comment
