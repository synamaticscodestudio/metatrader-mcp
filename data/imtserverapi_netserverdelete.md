...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Configuration Databases ](serverapi_configuration.md "Configuration databases") / [ Network ](serverapi_config_network.md "Network")/ NetServerDelete | [](imtserverapi_netserveradd.md "NetServerAdd") [](imtserverapi_netservershift.md "NetServerShift") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::NetServerDelete
Delete a server configuration by the index.
MTAPIRES IMTServerAPI::NetServerDelete( const UINT pos // Position of the configuration )  
---  
Parameters
pos
