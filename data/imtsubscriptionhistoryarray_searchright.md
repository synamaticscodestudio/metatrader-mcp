...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionHistoryArray ](imtsubscriptionhistoryarray.md "IMTSubscriptionHistoryArray")/ SearchRight | [](imtsubscriptionhistoryarray_searchleft.md "SearchLeft") [](imtsubscriptionsink.md "IMTSubscriptionHistorySink") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionHistoryArray::SearchRight
Search in an array for the last element equal to the search key.
int IMTSubscriptionHistoryArray::SearchRight( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
