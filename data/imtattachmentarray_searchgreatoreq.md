...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTAttachmentArray ](imtattachmentarray.md "IMTAttachmentArray")/ SearchGreatOrEq | [](imtattachmentarray_search.md "Search") [](imtattachmentarray_searchgreater.md "SearchGreater") |
| --- | --- | --- |
| --- | --- |

IMTAttachmentArray::SearchGreatOrEq
Search in an array for the first element greater than or equal to the search key.
int IMTAttachmentArray::SearchGreatOrEq( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
