# MTServerInfo (MetaTrader5SDK)

|  | [ Structures ](reference_structures.md "Structures")/ MTServerInfo | [](mtpluginparam.md "MTPluginParam") [](reference_configurations.md "Configuration Interfaces") |
| --- | --- | --- |
| --- | --- |
...
---  
This structure is used in the [IMTServerAPI::About](imtserverapi_about.md "About") method.
...
| server_type | UINT | Type of the server on which the plugin is running. To pass the server type, the [IMTConServer::EnServerTypes](imtconserver_enum.htm#enservertypes) enumeration is used. |
