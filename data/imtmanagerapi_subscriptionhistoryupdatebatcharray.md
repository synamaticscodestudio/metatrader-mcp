...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Subscriptions ](imtmanagerapi_subscription.md "Subscriptions")/ SubscriptionHistoryUpdateBatchArray | [](imtmanagerapi_subscriptionhistoryupdatebatch.md "SubscriptionHistoryUpdateBatch") [](imtmanagerapi_subscriptionhistorydelete.md "SubscriptionHistoryDelete") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::SubscriptionHistoryUpdateBatchArray( IMTSubscriptionHistory** records, // Array of actions MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.SubscriptionHistoryUpdateBatchArray( CIMTSubscriptionHistory[] records, // Array of actions MTRetCode[] res // Array of results )  
---  
Parameters
records
