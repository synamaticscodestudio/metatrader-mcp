...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Subscriptions ](imtmanagerapi_subscription.md "Subscriptions")/ SubscriptionDeleteBatch | [](imtmanagerapi_subscriptiondelete.md "SubscriptionDelete") [](imtmanagerapi_subscriptionrequest.md "SubscriptionRequest") |
| --- | --- | --- |
| --- | --- |

IMTManagerAPI::SubscriptionDeleteBatch
Delete a user subscription from the server database.
MTAPIRES IMTManagerAPI::SubscriptionDeleteBatch( const UINT64*  ids, // Array of IDs const UINT ids_total, // Number of IDs in the array MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.SubscriptionDeleteBatch( ulong[] ids, // Array of IDs MTRetCode[] retcodes // Array of results )  
---  
Parameters
ids
