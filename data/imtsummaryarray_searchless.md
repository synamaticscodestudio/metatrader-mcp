...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Summary Positions ](trading_summary.md "Summary Positions") / [ IMTSummaryArray ](imtsummaryarray.md "IMTSummaryArray")/ SearchLess | [](imtsummaryarray_searchlessoreq.md "SearchLessOrEq") [](imtsummaryarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTSummaryArray::SearchLess
Search in an array the first element less than the search key.
int IMTSummaryArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Sort function ) const  
---  
Parameters
*key
