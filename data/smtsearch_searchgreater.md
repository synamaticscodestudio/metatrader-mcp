...
|  | [ Tools ](reference_tools.md "Tools") / [ SMTSearch ](smtsearch.md "SMTSearch")/ SearchGreater | [](smtsearch_searchgreatoreq.md "SearchGreatOrEq") [](smtsearch_searchlessoreq.md "SearchLessOrEq") |
| --- | --- | --- |
| --- | --- |

SMTSearch::SearchGreater
Search in an array the first (from the array beginning) element greater than the search key.
static void* SMTSearch::SearchGreater( const void *key, // Search key void *base, // Array size_t total, // Number of elements const size_t width, // Element size SortFunctionPtr compare // A pointer to the search function )  
---  
Parameters
*key
