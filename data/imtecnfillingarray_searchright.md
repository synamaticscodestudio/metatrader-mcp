...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNFillingArray ](imtecnfillingarray.md "IMTECNFillingArray")/ SearchRight | [](imtecnfillingarray_searchleft.md "SearchLeft") [](imtecnprovider.md "IMTECNProvider") |
| --- | --- | --- |
| --- | --- |

IMTECNFillingArray::SearchRight
Search in an array the last element equal to the search key.
int IMTECNFillingArray::SearchRight( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
