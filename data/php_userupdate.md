...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ PHP Implementation of Protocol ](php.md "Protocol Implementation in PHP") / [ MTWebAPI Class ](mtwebapi.md "MTWebAPI Class") / [ Clients ](php_user.md "Clients")/ UserUpdate | [](php_useradd.md "UserAdd") [](php_userdelete.md "UserDelete") |
| --- | --- | --- |
| --- | --- |

MTWebAPI::UserUpdate
Change a client account on the server.
MTAPIRES MTWebAPI::UserUpdate( MTUser $user, // Modifications to a client account MTUser &$new_user // Modified client account )  
---  
Parameters
$user
[in] An object of a client account filled in with the user data that you need to change. The object must first be created using the [MTWebAPI::UserCreate](php_usercreate.md "UserCreate") method.
&$new_user
