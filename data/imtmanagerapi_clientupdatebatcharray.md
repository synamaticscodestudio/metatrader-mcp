...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ ClientUpdateBatchArray | [](imtmanagerapi_clientupdatebatch.md "ClientUpdateBatch") [](imtmanagerapi_clientdelete.md "ClientDelete") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::ClientUpdateBatchArray( IMTClient** clients, // array of clients const UINT clients_total, // number of clients in the array MTAPIRES* results // array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.ClientUpdateBatchArray( CIMTClient[] clients, // array of clients MTRetCode[] retcodes // array of results )  
---  
Parameters
clients
