...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Subscriptions ](imtmanagerapi_subscription.md "Subscriptions")/ SubscriptionDelete | [](imtmanagerapi_subscriptionupdatebatcharray.md "SubscriptionUpdateBatchArray") [](imtmanagerapi_subscriptiondeletebatch.md "SubscriptionDeleteBatch") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::SubscriptionDelete( const UINT64 id // Subscription ID )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTManagerAPI.SubscriptionDelete( ulong  id // Subscription ID )  
---  
Parameters
id
