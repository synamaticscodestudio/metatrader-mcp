...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryMatchingArray ](imtecnhistorymatchingarray.md "IMTECNMatchingArray")/ SearchGreater | [](imtecnhistorymatchingarray_searchgreatoreq.md "SearchGreatOrEq") [](imtecnhistorymatchingarray_searchlessoreq.md "SearchLessOrEq") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryMatchingArray::SearchGreater
Search in an array for the first element greater than the search key.
int IMTECNHistoryMatchingArray::SearchGreater( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
