...
|  | [ Configuration Interfaces ](reference_configurations.md "Configuration Interfaces") / [ Groups ](config_group.md "Groups") / [ IMTConGroupArray ](imtcongrouparray.md "IMTConGroupArray")/ SearchLess | [](imtcongrouparray_searchlessoreq.md "SearchLessOrEq") [](imtcongrouparray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTConGroupArray::SearchLess
Search an array for the first element less than the search key.
int IMTConGroupArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to search function ) const  
---  
Parameters
*key
