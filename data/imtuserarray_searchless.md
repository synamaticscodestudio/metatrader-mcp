...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Users ](reference_user.md "Users") / [ IMTUserArray ](imtuserarray.md "IMTUserArray")/ SearchLess | [](imtuserarray_searchlessoreq.md "SearchLessOrEq") [](imtuserarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTUserArray::SearchLess
Search in an array the first element less than the search key.
int IMTUserArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
