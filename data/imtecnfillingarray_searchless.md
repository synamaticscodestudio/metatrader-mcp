...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNFillingArray ](imtecnfillingarray.md "IMTECNFillingArray")/ SearchLess | [](imtecnfillingarray_searchlessoreq.md "SearchLessOrEq") [](imtecnfillingarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTECNFillingArray::SearchLess
Search in an array the first element less than the search key.
int IMTECNFillingArray::SearchLess( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
