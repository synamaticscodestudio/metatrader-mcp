...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTAttachmentArray ](imtattachmentarray.md "IMTAttachmentArray")/ SearchLess | [](imtattachmentarray_searchlessoreq.md "SearchLessOrEq") [](imtattachmentarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTAttachmentArray::SearchLess
Search in an array for the first element less than the search key.
int IMTAttachmentArray::SearchLess( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
