...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionHistoryArray ](imtsubscriptionhistoryarray.md "IMTSubscriptionHistoryArray")/ SearchLessOrEq | [](imtsubscriptionhistoryarray_searchgreater.md "SearchGreater") [](imtsubscriptionhistoryarray_searchless.md "SearchLess") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionHistoryArray::SearchLessOrEq
Search in an array for the first element less than or equal to the search key.
int IMTSubscriptionHistoryArray::SearchLessOrEq( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
