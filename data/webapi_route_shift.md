...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Configuration Databases ](webapi_config.md "Configuration Databases") / [ Routing ](webapi_route.md "Routing")/ Shift | [](webapi_route_delete.md "Delete") [](webapi_route_total.md "Get Total") |
| --- | --- | --- |
| --- | --- |
...
---  
Example
//--- request to the server GET /api/route/shift?index=0&shift=2 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
