...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Daily Reports ](trading_daily.md "Daily Reports") / [ IMTDailyArray ](imtdailyarray.md "IMTDailyArray")/ SearchLessOrEq | [](imtdailyarray_searchgreater.md "SearchGreater") [](imtdailyarray_searchless.md "SearchLess") |
| --- | --- | --- |
| --- | --- |

IMTDailyArray::SearchLessOrEq
Search in an array the first element less than or equal to the search key.
int IMTDailyArray::SearchLessOrEq( const void *key,  MTSortFunctionPtr sort_function ) const  
---  
Parameters
*key
