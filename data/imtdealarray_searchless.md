...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Deals ](trading_deal.md "Deals") / [ IMTDealArray ](imtdealarray.md "IMTDealArray")/ SearchLess | [](imtdealarray_searchlessoreq.md "SearchLessOrEq") [](imtdealarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTDealArray::SearchLess
Search in an array the first element less than the search key.
int IMTDealArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
