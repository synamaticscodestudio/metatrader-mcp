...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Trade Databases ](imtmanagerapi_trading.md "Trade Database Functions") / [ Orders ](imtmanagerapi_trading_order.md "Orders")/ OrderAddBatch | [](imtmanagerapi_orderadd.md "OrderAdd") [](imtmanagerapi_orderaddbatcharray.md "OrderAddBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::OrderAddBatch( IMTOrderArray* orders, // Array of orders MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.OrderAddBatch( CIMTOrderArray orders, // Array of orders MTRetCode[] res // Array of results )  
---  
Python
ManagerAPI.OrderAddBatch( orders # Array of orders )  
---  
Parameters
orders
