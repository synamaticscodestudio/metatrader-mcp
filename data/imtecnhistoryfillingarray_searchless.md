...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryFillingArray ](imtecnhistoryfillingarray.md "IMTECNFillingArray")/ SearchLess | [](imtecnhistoryfillingarray_searchlessoreq.md "SearchLessOrEq") [](imtecnhistoryfillingarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryFillingArray::SearchLess
Search in an array the first element less than the search key.
int IMTECNHistoryFillingArray::SearchLess( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
