...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Positions ](trading_position.md "Positions") / [ IMTPosition ](imtposition.md "IMTPosition")/ ActionGateway | [](imtposition_volumegatewayext.md "VolumeGatewayExt") [](imtpositionarray.md "IMTPositionArray") |
| --- | --- | --- |
| --- | --- |
...
C++
UINT IMTPosition::ActionGateway() const  
---  
.NET (Gateway/Manager API)
uint CIMTPosition.ActionGateway()  
---  
Return Value
...
C++
MTAPIRES IMTPosition::ActionGateway( const UINT action // direction )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTPosition.ActionGateway( uint action // direction )  
---  
Parameters
action
[in] Направление позиции. The direction is passed as a value from the [IMTDeal::EnDealAction](imtdeal_enum.htm#endealaction) enumeration: DEAL_BUY or DEAL_SELL.
Return Value
