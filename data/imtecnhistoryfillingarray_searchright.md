...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryFillingArray ](imtecnhistoryfillingarray.md "IMTECNFillingArray")/ SearchRight | [](imtecnhistoryfillingarray_searchleft.md "SearchLeft") [](imtecnhistorydeal.md "IMTECNFilling") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryFillingArray::SearchRight
Search in an array the last element equal to the search key.
int IMTECNHistoryFillingArray::SearchRight( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
