...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNMatchingArray ](imtecnmatchingarray.md "IMTECNMatchingArray")/ SearchRight | [](imtecnmatchingarray_searchleft.md "SearchLeft") [](imtecnfilling.md "IMTECNFilling") |
| --- | --- | --- |
| --- | --- |

IMTECNMatchingArray::SearchRight
Search in an array the last element equal to the search key.
int IMTECNMatchingArray::SearchRight( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
