...
|  | [ Configuration Interfaces ](reference_configurations.md "Configuration Interfaces") / [ Floating Margin ](config_leverage.md "Floating Margin") / [ IMTConLeverageArray ](imtconleveragearray.md "IMTConLeverageArray")/ SearchLess | [](imtconleveragearray_searchlessoreq.md "SearchLessOrEq") [](imtconleveragearray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTConLeverageArray::SearchLess
Search an array for the first element less than the search key.
int IMTConLeverageArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
