...
|  | [ Configuration Interfaces ](reference_configurations.md "Configuration Interfaces") / [ Floating Margin ](config_leverage.md "Floating Margin") / [ IMTConLeverageArray ](imtconleveragearray.md "IMTConLeverageArray")/ SearchLeft | [](imtconleveragearray_searchless.md "SearchLess") [](imtconleveragearray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTConLeverageArray::SearchLeft
Search an array for the first element equal to the search key.
int IMTConLeverageArray::SearchLeft( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
