...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Orders ](trading_order.md "Orders") / [ IMTOrderArray ](imtorderarray.md "IMTOrderArray")/ SearchLess | [](imtorderarray_searchlessoreq.md "SearchLessOrEq") [](imtorderarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTOrderArray::SearchLess
Search in an array the first element less than the search key.
int IMTOrderArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
