...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTAttachmentArray ](imtattachmentarray.md "IMTAttachmentArray")/ SearchRight | [](imtattachmentarray_searchleft.md "SearchLeft") [](reference_user.md "Users") |
| --- | --- | --- |
| --- | --- |

IMTAttachmentArray::SearchRight
Search in an array for the last element equal to the search key.
int IMTAttachmentArray::SearchRight( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
