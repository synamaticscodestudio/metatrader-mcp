...
|  | [ Tools ](reference_tools.md "Tools") / [ CMTArrayBase ](cmtarraybase.md "CMTArrayBase")/ SearchGreatOrEq | [](cmtarraybase_search.md "Search") [](cmtarraybase_searchgreater.md "SearchGreater") |
| --- | --- | --- |
| --- | --- |

CMTArrayBase::SearchGreatOrEq
Search in an array the first (from the array beginning) element greater than or equal to the search key.
static void* CMTArrayBase::SearchGreatOrEq( const void *key, // Search key SMTSearch::SortFunctionPtr sort_function // Sort function )  
---  
Parameters
*key
