...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryDealArray ](imtecnhistorydealarray.md "IMTECNMatchingArray")/ SearchLess | [](imtecnhistorydealarray_searchlessoreq.md "SearchLessOrEq") [](imtecnhistorydealarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryDealArray::SearchLess
Search in an array the first element less than the search key.
int IMTECNHistoryDealArray::SearchLess( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
