...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ CommentUpdateBatchArray | [](imtmanagerapi_commentupdatebatch.md "CommentUpdateBatch") [](imtmanagerapi_commentdelete.md "CommentDelete") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::CommentUpdateBatchArray( IMTComment** comments, // array of documents const UINT comments_total, // number of documents in the array MTAPIRES* results // array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.CommentUpdateBatchArray( CIMTComment[] comments, // array of documents MTRetCode[] retcodes // array of results )  
---  
Parameters
comments
