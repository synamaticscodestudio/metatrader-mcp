...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNFilling ](imtecnfilling.md "IMTECNFilling")/ Comment | [](imtecnfilling_provider.md "Provider") [](imtecnfillingarray.md "IMTECNFillingArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTECNFilling::Comment( LPCWSTR comment // identifier )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTECNFilling.Comment( string comment // identifier )  
---  
Parameters
comment
