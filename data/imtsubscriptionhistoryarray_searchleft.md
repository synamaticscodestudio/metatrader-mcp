...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionHistoryArray ](imtsubscriptionhistoryarray.md "IMTSubscriptionHistoryArray")/ SearchLeft | [](imtsubscriptionhistoryarray_searchless.md "SearchLess") [](imtsubscriptionhistoryarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionHistoryArray::SearchLeft
Search in an array for the first element equal to the search key.
int IMTSubscriptionHistoryArray::SearchLeft( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
