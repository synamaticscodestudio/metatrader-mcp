...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ .NET Implementation of Protocol ](net.md "Protocol Implementation in .NET") / [ MT5WebAPI Class ](net_mtwebapi.md "MT5WebAPI Class") / [ Mailbox ](net_mail.md "Mailbox")/ MailSend | [](net_mail.md "Mailbox") [](net_news.md "News Event") |
| --- | --- | --- |
| --- | --- |

MT5WebAPI.MailSend
Send mails via the internal mailing system of the trading platform.
MTRetCode MT5WebAPI.MailSend( string to, // Recipients string subject, // Subject string text  // Mail text )  
---  
Parameters
to
