...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Subscriptions ](imtmanagerapi_subscription.md "Subscriptions")/ SubscriptionHistoryDeleteBatch | [](imtmanagerapi_subscriptionhistorydelete.md "SubscriptionHistoryDelete") [](imtmanagerapi_subscriptionhistoryrequest.md "SubscriptionHistoryRequest") |
| --- | --- | --- |
| --- | --- |

IMTManagerAPI::SubscriptionHistoryDeleteBatch
Delete a batch of user subscription actions from the server database.
MTAPIRES IMTManagerAPI::SubscriptionHistoryDeleteBatch( const UINT64*  ids, // Array of IDs const UINT ids_total, // The number of IDs in the array MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.SubscriptionHistoryDeleteBatch( ulong[] ids, // Array of IDs MTRetCode[] retcodes // Array of results )  
---  
Parameters
ids
