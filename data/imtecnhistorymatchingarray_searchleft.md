...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryMatchingArray ](imtecnhistorymatchingarray.md "IMTECNMatchingArray")/ SearchLeft | [](imtecnhistorymatchingarray_searchless.md "SearchLess") [](imtecnhistorymatchingarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryMatchingArray::SearchLeft
Search in an array the first element equal to the search key.
int IMTECNHistoryMatchingArray::SearchLeft( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
