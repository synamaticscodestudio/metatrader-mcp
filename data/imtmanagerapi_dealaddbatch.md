...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Trade Databases ](imtmanagerapi_trading.md "Trade Database Functions") / [ Deals ](imtmanagerapi_trading_deal.md "Deals")/ DealAddBatch | [](imtmanagerapi_dealadd.md "DealAdd") [](imtmanagerapi_dealaddbatcharray.md "DealAddBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::DealAddBatch( IMTDealArray*  deals, // Array of deals MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.DealAddBatch( CIMTDealArray deals, // Array of deals MTRetCode[] res // Array of results )  
---  
Python
ManagerAPI.DealAddBatch( deals # Array of deals )  
---  
Parameters
deals
