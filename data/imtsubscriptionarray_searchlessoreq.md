...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionArray ](imtsubscriptionarray.md "IMTSubscriptionArray")/ SearchLessOrEq | [](imtsubscriptionarray_searchgreater.md "SearchGreater") [](imtsubscriptionarray_searchless.md "SearchLess") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionArray::SearchLessOrEq
Search in an array for the first element less than or equal to the search key.
int IMTSubscriptionArray::SearchLessOrEq( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
