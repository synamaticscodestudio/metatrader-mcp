...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Assets ](trading_exposure.md "Assets") / [ IMTExposureArray ](imtexposurearray.md "IMTExposureArray")/ SearchGreater | [](imtexposurearray_searchgreatoreq.md "SearchGreatOrEq") [](imtexposurearray_searchlessoreq.md "SearchLessOrEq") |
| --- | --- | --- |
| --- | --- |

IMTExposureArray::SearchGreater
Search in an array the first element greater than the search key.
int IMTExposureArray::SearchGreater( const void *key, // Sort key MTSortFunctionPtr sort_function // Sort function ) const  
---  
Parameters
*key
