...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Configuration Databases ](webapi_config.md "Configuration Databases") / [ Gateways ](webapi_gateway.md "Gateways")/ Shift | [](webapi_gateway_delete.md "Delete") [](webapi_gateway_total.md "Get Total") |
| --- | --- | --- |
| --- | --- |

Shift Gateway
The requests allows changing the position of a gateway configuration in the list.
Request Format
GET /api/gateway/shift?index=index&shift=shift POST /api/gateway/shift?index=index&shift=shift  
---  
Response Format
{ "retcode" : "code description" }  
---  
Example
//--- request to the server GET /api/gateway/shift?index=0&shift=2 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
