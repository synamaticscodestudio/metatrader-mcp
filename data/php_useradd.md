...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ PHP Implementation of Protocol ](php.md "Protocol Implementation in PHP") / [ MTWebAPI Class ](mtwebapi.md "MTWebAPI Class") / [ Clients ](php_user.md "Clients")/ UserAdd | [](php_usercreate.md "UserCreate") [](php_userupdate.md "UserUpdate") |
| --- | --- | --- |
| --- | --- |

MTWebAPI::UserAdd
Create a client account on the server.
MTAPIRES MTWebAPI::UserAdd( MTUser $user, // The client account you are creating MTUser &$new_user // The created client account )  
---  
Parameters
$user
[in] An object of a client account filled in with the data of the user that you need to create. The object must first be created using the [MTWebAPI::UserCreate](php_usercreate.md "UserCreate") method.
&$new_user
