...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Configuration Databases ](serverapi_configuration.md "Configuration databases") / [ Holidays ](serverapi_config_holiday.md "Holidays")/ HolidayShift | [](imtserverapi_holidaydelete.md "HolidayDelete") [](imtserverapi_holidaytotal.md "HolidayTotal") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::HolidayShift
Changes the position of a holiday configuration in the list.
MTAPIRES IMTServerAPI::HolidayShift( const UINT pos, // Position of the configuration const int shift // Shift )  
---  
Parameters
pos
