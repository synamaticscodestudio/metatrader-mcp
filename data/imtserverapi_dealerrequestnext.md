# DealerRequestNext (MetaTrader5SDK)

|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Trade ](serverapi_trading.md "Trade") / [ Request Processing ](serverapi_dealer.md "Processing of requests")/ DealerRequestNext | [](imtserverapi_dealerrequesttotal.md "DealerRequestTotal") [](imtserverapi_dealerrequestget.md "DealerRequestGet") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::DealerRequestNext
Gets a trade request with the specified index.
MTAPIRES IMTServerAPI::DealerRequestNext( const UINT64 dealer, // Dealer's login const UINT pos, // Trade request ID IMTRequest* request // An object of a trade request )  
---  
Parameters
dealer
