# Update Open (MetaTrader5SDK)

|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Trading ](webapi_trading.md "Trading") / [ Orders ](webapi_orders.md "Orders")/ Update Open | [](webapi_order_get_batch.md "Get Multiple Open") [](webapi_order_delete.md "Delete Open") |
| --- | --- | --- |
| --- | --- |

Update an Open Order
The request allows changing an open order on the server.
Request Format
POST /api/order/update { Description of the order to be changed in JSON format }  
---  
Response Format
{ "retcode" : "0 Done", "answer" : { description } }  
---  
Example
//--- request to the server POST /api/order/update { "Order" : "12832917", "ExternalID" : "", "Login" : "1020", ... } //--- server response { "retcode" : "0 Done", "answer" : {  "Order" : "12832917", "ExternalID" : "", "Login" : "1020", ... } }  
---  
Request Parameters
