...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTClientArray ](imtclientarray.md "IMTClientArray")/ SearchLess | [](imtclientarray_searchlessoreq.md "SearchLessOrEq") [](imtclientarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTClientArray::SearchLess
Search in an array for the first element less than the search key.
int IMTClientArray::SearchLess( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
