...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Trade ](serverapi_trading.md "Trade") / [ Orders ](serverapi_trading_order.md "Orders")/ OrderUpdateBatch | [](imtserverapi_orderupdate.md "OrderUpdate") [](imtserverapi_orderupdatebatcharray.md "OrderUpdateBatchArray") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::OrderUpdateBatch
Updates open orders in a server database in bulk.
MTAPIRES IMTServerAPI::OrderUpdateBatch( IMTOrderArray*  orders, // An array of orders MTAPIRES* results // An array of results )  
---  
Parameters
orders
