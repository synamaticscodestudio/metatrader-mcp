...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNFillingArray ](imtecnfillingarray.md "IMTECNFillingArray")/ SearchGreatOrEq | [](imtecnfillingarray_search.md "Search") [](imtecnfillingarray_searchgreater.md "SearchGreater") |
| --- | --- | --- |
| --- | --- |

IMTECNFillingArray::SearchGreatOrEq
Search in an array for the first element greater than or equal to the search key.
int IMTECNFillingArray::SearchGreatOrEq( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
