...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Tick Data ](serverapi_ticks.md "Tick Data")/ TickHistoryGetRaw | [](imtserverapi_tickget.md "TickGet") [](imtserverapi_tickhistoryget.md "TickHistoryGet") |
| --- | --- | --- |
| --- | --- |
...
MTAPIRES IMTServerAPI::TickHistoryGetRaw( LPCWSTR symbol, // Symbol const INT64 from, // Start date const INT64 to, // End date MTTickShort*& ticks, // A pointer to the array of structures of quotes UINT& ticks_total // Number of quotes )  
---  
Parameters
symbol
