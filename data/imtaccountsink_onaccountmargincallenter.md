# OnAccountMarginCallEnter (MetaTrader5SDK)

|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Accounts ](user_account.md "Accounts") / [ IMTAccountSink ](imtaccountsink.md "IMTAccountSink")/ OnAccountMarginCallEnter | [](imtaccountsink.md "IMTAccountSink") [](imtaccountsink_onaccountmargincallleave.md "OnAccountMarginCallLeave") |
| --- | --- | --- |
| --- | --- |
...
C++
virtual void IMTAccountSink::OnAccountMarginCallEnter( const IMTAccount* account, // a pointer to the trading state object const IMTConGroup* group // a pointer to the group object )  
---  
.NET (Manager API)
virtual void CIMTAccountSink::OnAccountMarginCallEnter( CIMTAccount account, // trading state object CIMTConGroup  group // group object )  
---  
Parameters
account
