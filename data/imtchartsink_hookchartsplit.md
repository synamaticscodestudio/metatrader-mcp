# HookChartSplit (MetaTrader5SDK)

|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Price Data ](reference_ticks.md "Price Data") / [ IMTChartSink ](imtchartsink.md "IMTChartSink")/ HookChartSplit | [](imtchartsink_onchartsplit.md "OnChartSplit") [](reference_dom.md "Depth of Market") |
| --- | --- | --- |
| --- | --- |
...
virtual MTAPIRES IMTChartSink::HookChartSplit( LPCWSTR symbol, // Symbol const double new_shares, // Number of new shares const double old_shares, // Number of old shares const UINT rounding_rule, // Rounding rule const INT64 datetime_from, // Beginning of split range const INT64 datetime_to // End of split range )  
---  
Parameters
news
...
Return Value
Return [MT_RET_OK](retcodes_successful.md "Successful completion") to allow splitting or any other response code to deny the operation.
Note
