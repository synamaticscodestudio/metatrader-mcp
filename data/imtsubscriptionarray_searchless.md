...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionArray ](imtsubscriptionarray.md "IMTSubscriptionArray")/ SearchLess | [](imtsubscriptionarray_searchlessoreq.md "SearchLessOrEq") [](imtsubscriptionarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionArray::SearchLess
Search in an array for the first element less than the search key.
int IMTSubscriptionArray::SearchLess( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
