...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ CommentAddBatch | [](imtmanagerapi_commentadd.md "CommentAdd") [](imtmanagerapi_commentaddbatcharray.md "CommentAddBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::CommentAddBatch( IMTCommentArray* comments, // array of comments MTAPIRES* results // array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.CommentAddBatch( CIMTCommentArray comments, // array of comments MTRetCode[] retcodes // array of results )  
---  
Parameters
comments
