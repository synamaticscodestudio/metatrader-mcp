...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTExecution ](imtexecution.md "IMTExecution")/ PriceGateway | [](imtexecution_apidataclearall.md "ApiDataClearAll") [](imtexecution_volumegatewayext.md "VolumeGatewayExt") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTExecution::PriceGateway( const double price // Deal execution price )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTExecution.PriceGateway( double price // Deal execution price )  
---  
Parameters
price
