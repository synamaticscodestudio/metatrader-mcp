...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Configuration Databases ](serverapi_configuration.md "Configuration databases") / [ Holidays ](serverapi_config_holiday.md "Holidays")/ HolidayDelete | [](imtserverapi_holidayadd.md "HolidayAdd") [](imtserverapi_holidayshift.md "HolidayShift") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::HolidayDelete
Delete a holiday configuration by the index.
MTAPIRES IMTServerAPI::HolidayDelete( const UINT pos // Position of the configuration )  
---  
Parameters
pos
