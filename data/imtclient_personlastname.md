# PersonLastName (MetaTrader5SDK)

|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTClient ](imtclient.md "IMTClient")/ PersonLastName | [](imtclient_personmiddlename.md "PersonMiddleName") [](imtclient_personbirthdate.md "PersonBirthDate") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTClient::PersonLastName( LPCWSTR last_name // Client's last name )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTClient.PersonLastName( string last_name // Client's last name )  
---  
Parameters
last_name
