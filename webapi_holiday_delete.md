...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Configuration Databases ](webapi_config.md "Configuration Databases") / [ Holidays ](webapi_holiday.md "Holidays")/ Delete | [](webapi_holiday_add.md "Add") [](webapi_holiday_shift.md "Shift") |
| --- | --- | --- |
| --- | --- |
...
---  
Example
//--- request to the server GET /api/holiday/delete?index=0 //--- server response { "retcode" : "0 Done" }  
---  
Request Parameters
