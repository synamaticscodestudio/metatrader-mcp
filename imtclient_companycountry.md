# CompanyCountry (MetaTrader5SDK)

|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Clients ](reference_client.md "Clients") / [ IMTClient ](imtclient.md "IMTClient")/ CompanyCountry | [](imtclient_companylicenseauthority.md "CompanyLicenseAuthority") [](imtclient_companyaddress.md "CompanyAddress") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTClient::CompanyCountry( LPCWSTR country // Registration country )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTClient.CompanyCountry( string country  // Registration country )  
---  
Parameters
country
