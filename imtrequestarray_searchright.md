...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTRequestArray ](imtrequestarray.md "IMTRequestArray")/ SearchRight | [](imtrequestarray_searchleft.md "SearchLeft") [](imtrequestsink.md "IMTRequestSink") |
| --- | --- | --- |
| --- | --- |

IMTRequestArray::SearchRight
Search in an array the last element equal to the search key.
int IMTRequestArray::SearchRight( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
