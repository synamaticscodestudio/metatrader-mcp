...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ ClientUpdate | [](imtmanagerapi_clientaddarraybatch.md "ClientAddBatchArray") [](imtmanagerapi_clientupdatebatch.md "ClientUpdateBatch") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::ClientUpdate( IMTClient* client // client object )  
---  
.NET
MTRetCode CIMTManagerAPI.ClientUpdate( CIMTClient client // client object )  
---  
Python
ManagerAPI.ClientUpdate( MTClient client # client object )  
---  
Parameters
client
