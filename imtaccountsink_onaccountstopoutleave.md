# OnAccountStopOutLeave (MetaTrader5SDK)

|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Accounts ](user_account.md "Accounts") / [ IMTAccountSink ](imtaccountsink.md "IMTAccountSink")/ OnAccountStopOutLeave | [](imtaccountsink_onaccountstopoutenter.md "OnAccountStopOutEnter") [](trading_request.md "Trade Requests") |
| --- | --- | --- |
| --- | --- |
...
C++
virtual void IMTAccountSink::OnAccountStopOutLeave( const IMTAccount* account, // a pointer to the trading state object const IMTConGroup* group // a pointer to the group object )  
---  
.NET (Manager API)
virtual void CIMTAccountSink::OnAccountStopOutLeave( CIMTAccount account, // trading state object CIMTConGroup  group // group object )  
---  
Parameters
account
