...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionArray ](imtsubscriptionarray.md "IMTSubscriptionArray")/ SearchRight | [](imtsubscriptionarray_searchleft.md "SearchLeft") [](imtsubscriptionhistory.md "IMTSubscriptionHistory") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionArray::SearchRight
Search in an array for the last element equal to the search key.
int IMTSubscriptionArray::SearchRight( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
