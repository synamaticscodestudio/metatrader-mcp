...
|  | [ Web API ](webapi.md "Web API") / [ Manager Interface (Rest API) ](webapi_main.md "Manager Interface \(Rest API\)") / [ Trading ](webapi_trading.md "Trading") / [ Deals ](webapi_deal.md "Deals")/ Get Backups List | [](webapi_deal_delete.md "Delete") [](webapi_deal_backup_get.md "Get Deals from Backup") |
| --- | --- | --- |
| --- | --- |
...
Request Format
GET /api/deal/backup/list?from=beginning&to=end&server=identifier POST /api/deal/backup/list?from=beginning&to=end&server=identifier  
---  
Response Format
{ "retcode" : "code description", "answer" : [ date list ] }  
---  
Example
//--- request to the server GET /api/deal/backup/list?from=1546357749&to=1574351349 //--- server response { "retcode" : "0 Done", "answer" : [ 1574122620,1574209020,1574250008 ] }  
---  
Request Parameters
...
Note
The received dates can be used in [/api/deal/backup/get](webapi_deal_backup_get.md "Get Deals from Backup") to request deal data from specific backups.