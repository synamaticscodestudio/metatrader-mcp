...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNHistoryMatchingArray ](imtecnhistorymatchingarray.md "IMTECNMatchingArray")/ SearchGreatOrEq | [](imtecnhistorymatchingarray_search.md "Search") [](imtecnhistorymatchingarray_searchgreater.md "SearchGreater") |
| --- | --- | --- |
| --- | --- |

IMTECNHistoryMatchingArray::SearchGreatOrEq
Search in an array for the first element greater than or equal to the search key.
int IMTECNHistoryMatchingArray::SearchGreatOrEq( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
