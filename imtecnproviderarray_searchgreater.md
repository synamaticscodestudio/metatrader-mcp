...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNProviderArray ](imtecnproviderarray.md "IMTECNProviderArray")/ SearchGreater | [](imtecnproviderarray_searchgreatoreq.md "SearchGreatOrEq") [](imtecnproviderarray_searchlessoreq.md "SearchLessOrEq") |
| --- | --- | --- |
| --- | --- |

IMTECNProviderArray::SearchGreater
Search in an array for the first element greater than the search key.
int IMTECNProviderArray::SearchGreater( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
