...
|  | [ Configuration Interfaces ](reference_configurations.md "Configuration Interfaces") / [ Symbols ](config_symbol.md "Symbols") / [ IMTConSymbolArray ](imtconsymbolarray.md "IMTConSymbolArray")/ SearchLeft | [](imtconsymbolarray_searchless.md "SearchLess") [](imtconsymbolarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTConSymbolArray::SearchLeft
Search an array for the first element equal to the search key.
int IMTConSymbolArray::SearchLeft( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to search function ) const  
---  
Parameters
*key
