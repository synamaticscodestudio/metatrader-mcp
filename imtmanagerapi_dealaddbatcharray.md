...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Trade Databases ](imtmanagerapi_trading.md "Trade Database Functions") / [ Deals ](imtmanagerapi_trading_deal.md "Deals")/ DealAddBatchArray | [](imtmanagerapi_dealaddbatch.md "DealAddBatch") [](imtmanagerapi_dealupdate.md "DealUpdate") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::DealAddBatchArray( IMTDeal**  deals, // Array of deals const UINT deals_total, // Number of deals in the array MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.DealAddBatchArray( CIMTDeal[] deals, // Array of deals MTRetCode[] retcodes // Array of results )  
---  
Parameters
deals
