# ActionGateway (MetaTrader5SDK)

|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTExecution ](imtexecution.md "IMTExecution")/ ActionGateway | [](imtexecution_volumegatewayext.md "VolumeGatewayExt") [](imtexecution_gatewayid.md "GatewayID") |
| --- | --- | --- |
| --- | --- |

IMTExecution::ActionGateway
Get the direction with which the deal is actually routed to an external trading system through the gateway.
C++
UINT IMTExecution::ActionGateway() const  
---  
.NET (Gateway/Manager API)
uint CIMTExecution.ActionGateway()  
---  
Return Value
A value from the [IMTDeal::EnDealAction](imtdeal_enum.htm#endealaction) enumeration: DEAL_BUY or DEAL_SELL.
IMTExecution::ActionGateway
Set the direction with which the deal is actually routed to an external trading system through the gateway.
C++
MTAPIRES IMTExecution::ActionGateway( const UINT action // direction )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTExecution.ActionGateway( uint action // direction )  
---  
Parameters
action
[in] The direction of a deal. The direction is passed as a value from the [IMTDeal::EnDealAction](imtdeal_enum.htm#endealaction) enumeration: DEAL_BUY or DEAL_SELL.
Return Value
