...
|  | [ Tools ](reference_tools.md "Tools") / [ CMTArrayBase ](cmtarraybase.md "CMTArrayBase")/ SearchLeft | [](cmtarraybase_searchless.md "SearchLess") [](cmtarraybase_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

CMTArrayBase::SearchLeft
Search in an array the first element equal to the search key.
static void* CMTArrayBase::SearchLeft( const void *key, // Search key SMTSearch::SortFunctionPtr sort_function // Sort function )  
---  
Parameters
*key
