...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTRequestArray ](imtrequestarray.md "IMTRequestArray")/ SearchLess | [](imtrequestarray_searchlessoreq.md "SearchLessOrEq") [](imtrequestarray_searchleft.md "SearchLeft") |
| --- | --- | --- |
| --- | --- |

IMTRequestArray::SearchLess
Search in an array the first element less than the search key.
int IMTRequestArray::SearchLess( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
