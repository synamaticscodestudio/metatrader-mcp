...
|  | [ Manager API ](managerapi.md "Manager API") / [ Administrator Interface ](imtadminapi.md "Administrator Interface") / [ Trade Databases ](imtadminapi_trading.md "Trade Database Functions") / [ Positions ](imtadminapi_trading_position.md "Functions")/ PositionDelete | [](imtadminapi_positionupdatebatcharray.md "PositionUpdateBatchArray") [](imtadminapi_positiondeletebyticket.md "PositionDeleteByTicket") |
| --- | --- | --- |
| --- | --- |
...
Deletes a position.
C++
MTAPIRES IMTAdminAPI::PositionDelete( IMTPosition* position // Position object )  
---  
.NET
MTRetCode CIMTAdminAPI.PositionDelete( CIMTPosition position // Position object )  
---  
Python
AdminAPI.PositionDelete( position # Position object )  
---  
Parameters
position
