...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Clients ](imtmanagerapi_clients.md "Clients")/ DocumentAdd | [](imtmanagerapi_documentcreatearray.md "DocumentCreateArray") [](imtmanagerapi_documentaddbatch.md "DocumentAddBatch") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::DocumentAdd( IMTDocument* document // document object )  
---  
.NET
MTRetCode CIMTManagerAPI.DocumentAdd( CIMTDocument document // document object )  
---  
Parameters
document
