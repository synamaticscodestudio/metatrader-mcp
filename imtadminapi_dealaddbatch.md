...
|  | [ Manager API ](managerapi.md "Manager API") / [ Administrator Interface ](imtadminapi.md "Administrator Interface") / [ Trade Databases ](imtadminapi_trading.md "Trade Database Functions") / [ Deals ](imtadminapi_trading_deal.md "Functions")/ DealAddBatch | [](imtadminapi_dealadd.md "DealAdd") [](imtadminapi_dealaddbatcharray.md "DealAddBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTAdminAPI::DealAddBatch( IMTDealArray*  deals, // Array of deals MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTAdminAPI.DealAddBatch( CIMTDealArray deals, // Array of deals MTRetCode[] res // Array of results )  
---  
Python
AdminAPI.DealAddBatch( deals # Array of deals )  
---  
Parameters
deals
