...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Trade Requests ](trading_request.md "Trade Requests") / [ IMTConfirm ](imtconfirm.md "IMTConfirm")/ ActionGateway | [](imtconfirm_volumegatewayext.md "VolumeGatewayExt") [](imtconfirm_externalretcode.md "ExternalRetcode") |
| --- | --- | --- |
| --- | --- |

IMTConfirm::ActionGateway
Get the direction with which the deal is actually routed to an external trading system through the gateway.
C++
UINT IMTConfirm::ActionGateway() const  
---  
.NET (Gateway/Manager API)
uint CIMTConfirm.ActionGateway()  
---  
Return Value
...
C++
MTAPIRES IMTConfirm::ActionGateway( const UINT action // direction )  
---  
.NET (Gateway/Manager API)
MTRetCode CIMTConfirm.ActionGateway( uint action // direction )  
---  
Parameters
action
