...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ ECN ](reference_ecn.md "The ECN") / [ IMTECNMatchingArray ](imtecnmatchingarray.md "IMTECNMatchingArray")/ SearchLeft | [](imtecnmatchingarray_searchless.md "SearchLess") [](imtecnmatchingarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTECNMatchingArray::SearchLeft
Search in an array the first element equal to the search key.
int IMTECNMatchingArray::SearchLeft( const void* key, // sorting key MTSortFunctionPtr sort_function // a pointer to the search array ) const  
---  
Parameters
key
