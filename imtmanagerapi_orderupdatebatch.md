...
|  | [ Manager API ](managerapi.md "Manager API") / [ Manager Interface ](imtmanagerapi.md "Manager Interface") / [ Trade Databases ](imtmanagerapi_trading.md "Trade Database Functions") / [ Orders ](imtmanagerapi_trading_order.md "Orders")/ OrderUpdateBatch | [](imtmanagerapi_orderupdate.md "OrderUpdate") [](imtmanagerapi_orderupdatebatcharray.md "OrderUpdateBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTManagerAPI::OrderUpdateBatch( IMTOrderArray* orders, // Array of orders MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTManagerAPI.OrderUpdateBatch( CIMTOrderArray orders, // Array of orders MTRetCode[] res // Array of results )  
---  
Python
ManagerAPI.OrderUpdateBatch( orders # Array of orders )  
---  
Parameters
orders
