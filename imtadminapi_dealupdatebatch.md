...
|  | [ Manager API ](managerapi.md "Manager API") / [ Administrator Interface ](imtadminapi.md "Administrator Interface") / [ Trade Databases ](imtadminapi_trading.md "Trade Database Functions") / [ Deals ](imtadminapi_trading_deal.md "Functions")/ DealUpdateBatch | [](imtadminapi_dealupdate.md "DealUpdate") [](imtadminapi_dealupdatebatcharray.md "DealUpdateBatchArray") |
| --- | --- | --- |
| --- | --- |
...
C++
MTAPIRES IMTAdminAPI::DealUpdateBatch( IMTDealArray*  deals, // Array of deals MTAPIRES* results // Array of results )  
---  
.NET
MTRetCode CIMTAdminAPI.DealUpdateBatch( CIMTDealArray deals, // Array of deals MTRetCode[] res // Array of results )  
---  
Python
AdminAPI.DealUpdateBatch( deals # Array of deals )  
---  
Parameters
deals
