...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Subscriptions ](reference_subscription.md "Subscriptions") / [ IMTSubscriptionArray ](imtsubscriptionarray.md "IMTSubscriptionArray")/ SearchLeft | [](imtsubscriptionarray_searchless.md "SearchLess") [](imtsubscriptionarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTSubscriptionArray::SearchLeft
Search in an array for the first element equal to the search key.
int IMTSubscriptionArray::SearchLeft( const void* key, // Sorting key MTSortFunctionPtr sort_function // A pointer to the search function ) const  
---  
Parameters
key
