...
|  | [ Server API ](serverapi.md "Server API") / [ Main API Interface ](imtserverapi.md "Main API Interface") / [ Trade ](serverapi_trading.md "Trade") / [ Orders ](serverapi_trading_order.md "Orders")/ OrderCancelBatch | [](imtserverapi_ordercancel.md "OrderCancel") [](imtserverapi_orderget.md "OrderGet") |
| --- | --- | --- |
| --- | --- |

IMTServerAPI::OrderCancelBatch
Move multiple open order to history.
MTAPIRES IMTServerAPI::OrderCancelBatch( const UINT64*  tickets, // array of tickets const UINT tickets_total, // number of tickets in the array MTAPIRES* results // array of results )  
---  
Parameters
tickets
