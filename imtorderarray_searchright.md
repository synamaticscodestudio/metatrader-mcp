...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Orders ](trading_order.md "Orders") / [ IMTOrderArray ](imtorderarray.md "IMTOrderArray")/ SearchRight | [](imtorderarray_searchleft.md "SearchLeft") [](imtordersink.md "IMTOrderSink") |
| --- | --- | --- |
| --- | --- |

IMTOrderArray::SearchRight
Search in an array the last element equal to the search key.
int IMTOrderArray::SearchRight( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
