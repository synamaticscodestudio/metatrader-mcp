...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Assets ](trading_exposure.md "Assets") / [ IMTExposureArray ](imtexposurearray.md "IMTExposureArray")/ SearchRight | [](imtexposurearray_searchleft.md "SearchLeft") [](imtexposuresink.md "IMTExposureSink") |
| --- | --- | --- |
| --- | --- |

IMTExposureArray::SearchRight
Search in an array the last element equal to the search key.
int IMTExposureArray::SearchRight( const void *key, // Sort key MTSortFunctionPtr sort_function // Sort function ) const  
---  
Parameters
*key
