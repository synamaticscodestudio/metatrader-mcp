...
|  | [ Database Interfaces ](reference_bases.md "Database Interfaces") / [ Trade ](reference_trading.md "Trade") / [ Orders ](trading_order.md "Orders") / [ IMTOrderArray ](imtorderarray.md "IMTOrderArray")/ SearchLeft | [](imtorderarray_searchless.md "SearchLess") [](imtorderarray_searchright.md "SearchRight") |
| --- | --- | --- |
| --- | --- |

IMTOrderArray::SearchLeft
Search in an array the first element equal to the search key.
int IMTOrderArray::SearchLeft( const void *key, // Sort key MTSortFunctionPtr sort_function // Pointer to the search function ) const  
---  
Parameters
*key
